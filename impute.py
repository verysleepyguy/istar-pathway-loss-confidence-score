...
def export_pathway_confidence_inputs(
    ...
    # First simple calibration export for pathway_confidence.py. The true
    # calibration matrix is the existing measured pathway target matrix, the
    # calibration prediction matrix is model output on those same measured
    # spots, and the test prediction matrix is the already produced full
    # super-resolution pathway maps. A future version should export held-out
    # calibration folds to avoid double dipping.
    names = list(names)
    ...
    test_pred = load_prediction_maps(prefix, output_dir, names, file_names)
